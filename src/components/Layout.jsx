...
function Layout() {
    ...
    <>
    <Outlet/>
    <div className='container m-auto' style={{position: 'relative', zIndex: '3'}}>
        <footer className="footer items-center p-4 bg-neutral text-neutral-content peda" >
        ...
        <p>Copyright © 2024 - All right reserved - Designed by DJ</p>
          </aside> 
